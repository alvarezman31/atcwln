<%@ Page Title="" Language="C#" MasterPageFile="~/SiteElectro.Master" AutoEventWireup="true" CodeBehind="mantCanales.aspx.cs" Inherits="AtcWln.mantener.mantCanales" %>
    ...
    <asp:MultiView ID="MultiView1" runat="server" >
        <asp:View ID="vwDatos" runat="server">
            ...
            <div style="display: block; margin:5px; padding:5px;border:0px solid;" >
                <div >
                    <asp:Label ID="LbOpcion" runat="server" Text="Canales"  Font-Bold="True" Font-Size="12pt" BorderColor="#0033CC" ></asp:Label>
                </div>

                <div >
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/canales.png" Height="150px" Width="150px" />
                </div>
            </div>
            <div style="display: block; margin:5px; padding:5px;border:0px solid;" >
                <div >
...
<br/>
            ...
            <div align="center"  style="border:0px solid;margin:auto;"> 
                <div style="display: block; margin:5px; padding:5px;border:0px solid;" >
                    <div >
                        <asp:Image ID="Image3" runat="server" ImageUrl="~/images/canales.png" Height="100px" Width="100px" />
                    </div>
                    <div >
                        <asp:Label ID="lbCanales1" runat="server" Text="Canales" ></asp:Label>
                    </div>            
                </div>
            </div>
           ...
           <!-- <div style="display: inline-block; margin:10px; padding:10px; border:1px solid;" >
                ...
                <asp:DataList ID="DataList1" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" CellSpacing="20" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Size="Medium" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" OnSelectedIndexChanged="DataList1_SelectedIndexChanged"  >
                    ...
                    <ItemTemplate>
                        ...
                        <asp:Label ID="Label1" runat="server" Text='<%# Eval("codigo") %>' Width="150px" CssClass="busqueda1"></asp:Label>
                        </div> 
                        <div  class="descrip1" style="display:inline-block;">
                            <asp:Label ID="Label2" runat="server" style="margin-right: 36px" Text='<%# Eval("descripcion") %>' ></asp:Label>
                        </div>
                        <div  style="display:inline-block;">
