<%@ Page Title="" Language="C#" enableEventValidation="false" MasterPageFile="~/SiteElectro.Master" AutoEventWireup="true" CodeBehind="mantServicios.aspx.cs" Inherits="AtcWln.mantener.mantServicios" %>
    ...
    <asp:MultiView ID="MultiView1" runat="server" >
        <asp:View ID="vwDatos" runat="server">
            ...
            <div style="display: block; margin:5px; padding:5px;border:0px solid;" >
                <div >
                    <asp:Label ID="LbOpcion" runat="server" Text="Servicios"  Font-Bold="True" Font-Size="12pt" BorderColor="#0033CC" ></asp:Label>
                </div>
                <div >
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/servicios.png" Height="150px" Width="150px" />
                </div>
            </div>
            <div style="display: block; margin:5px; padding:5px;border:0px solid;" >
                <div >
        ...
        <div align="center" > 
            ...
            <div style="display: inline-block; margin:10px; padding:10px;border:0px solid;" >
                ...
                <div >
                    <asp:TextBox ID="TxtCodigo" runat="server" MaxLength="5"   Width="218px" AutoPostBack="True"  OnTextChanged="TxtCodigo_TextChanged1" ></asp:TextBox>
                </div>
            </div>
             <div style="display: inline-block; margin:10px; padding:10px;border:0px solid;" >
                <div >
            ...
            <div style="display: inline-block; margin:10px; padding:10px;border:0px solid;" >
                ...
                <div >
                    <asp:DropDownList ID="DDLgrupo" runat="server" Height="20px" Width="220px" AutoPostBack="true" OnSelectedIndexChanged="DDLgrupo_SelectedIndexChanged" OnTextChanged="DDLgrupo_SelectedIndexChanged"></asp:DropDownList>
                </div>
            </div>        
<div align="center" > 
            <div style="display: inline-block; margin:10px; padding:10px;border:0px solid;" >
                <div >
                    <asp:Label ID="lbSubgrupo" runat="server" Text="Sub-Grupo" ></asp:Label>
                </div>
                <div >
                    <asp:DropDownList ID="DDLSubgrupo" runat="server" Height="20px" Width="220px" AutoPostBack="false"></asp:DropDownList>
                </div>
            </div>    
            <div style="display: inline-block; margin:10px; padding:10px;border:0px solid;" >
                <div >
                    <asp:Label ID="LlmensajeInicial" runat="server" Text="Mensaje Inicial" ></asp:Label>
                </div>
                <div >
                     <asp:TextBox ID="TxtMensajeInicial" runat="server" MaxLength="100" Width="220px" Height="50px"  TextMode="MultiLine"  ></asp:TextBox>
                </div>
            </div>
             <div style="display: inline-block; margin:10px; padding:10px;border:0px solid;float:initial" >
                <div >
                    <asp:Label ID="lbRespuesta" runat="server" Text="Mensaje/Respuesta" ></asp:Label>
                </div>
                <div >
                    <asp:TextBox ID="TxtMensaje" runat="server" Width="320px" Height="100px" TextMode="MultiLine"  ></asp:TextBox>
                </div>
            </div>
    </div>
...
<br/>
            ...
            <div align="center"  style="border:0px solid;margin:auto;"> 
                <div style="display: block; margin:5px; padding:5px;border:0px solid;" >
                    <div >
                        <asp:Image ID="Image3" runat="server" ImageUrl="~/images/servicios.png" Height="100px" Width="100px" />
                    </div>
                    <div >
                        <asp:Label ID="lbServicios1" runat="server" Text="Servicios" ></asp:Label>
                    </div>     
                </div>
            </div>
            <br/>
           ...
           <!-- <div style="display: inline-block; margin:10px; padding:10px; border:1px solid;" >
                    ...
                    <HeaderTemplate>
                        <table class="nav-justified">
                            <tr class ="busqueda1">
                                ...
                                <td class="modal-sm descrip1" style="color: white; ">Descripción</td>
                                <td style="color: white; width: 50px;" >Seleccionar</td>
                            </tr>
                        </table>
                    </HeaderTemplate>
                    <ItemTemplate>
                        <div style="display:inline-block;">
                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("codigo") %>' Width="100px" CssClass="busqueda1" ></asp:Label>
                        </div>
                        <div  class="descrip1" style="display:inline-block;">
            ...
            <asp:DataList ID="DataList2" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" CellSpacing="20" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Size="Medium" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center"  >
                    ...
                    <ItemTemplate>
                        <div style="text-align:center;float:left;border:2px solid;" >
                            <asp:Label ID="Label1" runat="server" Visible="false" Text='<%# Eval("codigo") %>' Width="150px"></asp:Label>
                            <asp:LinkButton ID="link1" runat="server" Text='<%# Eval("descripcion") %>' OnClick="link1_Click" ></asp:LinkButton>
                        </div>
                        <div style="text-align:center;float:left;border:2px solid;" >
                            <asp:Label ID="Label2" runat="server" style="margin-right: 36px" Text='<%# Eval("descripcion") %>' Visible="false"></asp:Label>
                        </div>
                        <div style="text-align:center;float:right;border:2px solid;" >
                            <asp:ImageButton ID="Image2" runat="server" ImageUrl="~/images/seleccion.png" Width="30px" OnClick="Image2_Click" Height="30px"  />
                        </div>
                    </ItemTemplate>
                    <SelectedItemStyle BackColor="#000099" Font-Bold="True" ForeColor="White" />
                    <SeparatorStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" VerticalAlign="Middle" />
