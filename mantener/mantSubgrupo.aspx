<%@ Page Title="" Language="C#" MasterPageFile="~/SiteElectro.Master" AutoEventWireup="true" CodeBehind="mantSubgrupo.aspx.cs" Inherits="AtcWln.mantener.mantSubgrupo" %>
    ...
    <asp:MultiView ID="MultiView1" runat="server" >
        <asp:View ID="vwDatos" runat="server">
            ...
            <div style="display: block; margin:5px; padding:5px;border:0px solid;" >
                <div >
                    <asp:Label ID="LbOpcion" runat="server" Text="Sub-Grupos"  Font-Bold="True" Font-Size="12pt" BorderColor="#0033CC" ></asp:Label>
                </div>
                <div >
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/subgrupo.png" Height="150px" Width="150px" />
                </div>
            </div>
            <div style="display: block; margin:5px; padding:5px;border:0px solid;" >
                <div >
        ...
        <div align="center" > 
            ...
            <div style="display: inline-block; margin:10px; padding:10px;border:0px solid;" >
                ...
                <div >
                    <asp:DropDownList ID="DDLgrupo" runat="server" Height="20px" Width="220px" AutoPostBack="false"></asp:DropDownList>
                </div>
            </div>        
        </div>
            <br/>
...
<br/>
            ...
            <div align="center"  style="border:0px solid;margin:auto;"> 
                <div style="display: block; margin:5px; padding:5px;border:0px solid;" >
                    <div >
                        <asp:Image ID="Image3" runat="server" ImageUrl="~/images/subgrupo.png" Height="100px" Width="100px" />
                    </div>
                </div>
            </div>
            <br/>
