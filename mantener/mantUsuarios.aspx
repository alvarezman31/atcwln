<%@ Page Title="" Language="C#" MasterPageFile="~/SiteElectro.Master" AutoEventWireup="true" CodeBehind="mantUsuarios.aspx.cs" Inherits="AtcWln.mantener.mantUsuarios" %>
...
function mostrarPass(objeto1) {
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        ...
        <div align="center" > 
            ...
            <div style="display: block; margin:5px; padding:5px;border:0px solid;" >                
                <div >
                    <asp:Label ID="LbOpcion" runat="server" Text="Usuarios"  Font-Bold="True" Font-Size="12pt" BorderColor="#0033CC" ></asp:Label>
                </div>
                <div >
                    <asp:Image ID="Image1" runat="server" ImageUrl="~/images/usuarios.jpg" Height="100px" Width="100px" />
                </div>
            </div>
        </div>
          <div align="center" >
          ...
          <br />
                    ...
                    <div style="display: inline-block; margin:10px; padding:10px;" >
                     ...
                     <div style="display: inline-block; margin:10px; padding:10px;" >
                        <div >     
                            Password</div>
                        <div >
                            <asp:TextBox ID="txtPassword" runat="server" Width="220px" required TextMode="Password"></asp:TextBox>
                        ...
                        <div >     
                            <asp:Label ID="LblConfirmar" runat="server" Text="Confirmar Password" Visible="false"></asp:Label>

                        </div>                      
                         <div >
                            <asp:TextBox ID="txtPassword2" runat="server" Width="220px" required TextMode="Password" Visible="false" ></asp:TextBox>
                        </div>
                    </div>
                </div>
            ...
            <div align="center" >
                <div style="display: inline-block; margin:10px; padding:10px;border:0px solid;" >
                    ...
                    <div >
                        <asp:DropDownList ID="DDLTipo" runat="server" Height="20px" Width="220px" AutoPostBack="false" Enabled="false"></asp:DropDownList>
                    </div>
                </div>   
                <div style="display: inline-block; margin:10px; padding:10px;border:0px solid;" >
                    <div >
                        <asp:Label ID="LbClientes" runat="server" Text="Empresa" ></asp:Label>
                    </div>
                    <div >
                        <asp:DropDownList ID="DDLClientes" runat="server" Height="20px" Width="220px" AutoPostBack="false" Enabled="false"></asp:DropDownList>
                    </div>
                </div>   
            </div>
             <br />
        ...
        <asp:View ID="vwLista" runat="server">
            ...
            <div align="center"  style="border:0px solid;margin:auto;"> 
                <div style="display: block; margin:5px; padding:5px;border:0px solid;" >
                    <div >
                        <asp:Image ID="Image3" runat="server" ImageUrl="~/images/usuarios.jpg" Height="100px" Width="100px" />
                    </div>
                    <div >
                        <asp:Label ID="lbServicios1" runat="server" Text="Usuarios" ></asp:Label>
                    </div>     
                </div>
            </div>
            ...
            <div style="display:inline-block;  margin:10px; padding:10px;border:0px solid; " >
                <asp:DataList ID="DataList1" runat="server" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical" CellSpacing="20" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Size="Medium" Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center"  style="margin-right: 0px" >
                    ...
                    <HeaderTemplate>
                        ...
                        <div style="text-align:center;float:left;border:0px solid;border-color:white;" class="busqueda1">
                            <asp:Label ID="Label8" runat="server" Text='Nombres' Width="250px"></asp:Label>
                        </div>
